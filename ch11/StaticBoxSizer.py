...
class TestFrame(wx.Frame):
    def __init__(self):
        ...
        #make three staic boxes with windows positioned inside them
        ...
        #We can alse use a sizer to manage the placement of other sizers (and therefore the windows and sub-sizers that they manage as well.)
