...
# -*- coding:utf-8 -*-
import wx
from ch05_AbstractModel import AbstractModel
...
class ModelExample(wx.Frame):
    ...
    def createCaptionedText(self,parent,label,pos):
        static = wx.StaticText(parent,wx.NewId(),label,pos)
        static.SetBackgroundColour('White')
        textPos = (pos[0]+75,pos[1])
        self.textFields[label] = wx.TextCtrl(parent,wx.NewId(),"",
