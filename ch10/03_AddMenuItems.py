...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        self.Bind(wx.EVT_BUTTON, self.OnAddItem, btn) # Bind button event
    ...
    def OnAddItem(self, evt):
        item = self.menu.Append(-1, self.txt.GetValue())   # Add new menu item
        self.Bind(wx.EVT_MENU, self.OnNewItemSelected, item)    # Bind the menu event
